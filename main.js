...
ScrollReveal().reveal('.conteudo-2', {
  origin: 'left',
  duration: 1000,
  distance: '20%'
});
...
//BLINDAGENS //BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS
//BLINDAGENS //BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS
//BLINDAGENS //BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS
//BLINDAGENS //BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS
//BLINDAGENS //BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS//BLINDAGENS

let blindagemLimparPgtoSelecionado  = () =>{
...
if (btn) {
  ...
  span.onclick = function () {
    ...
    blindagemLimparPgtoSelecionado();

//blindagem para remover o pagamento selecioando na hr de fechar o modal
...
var expirationdate_mask = new IMask(expirationdate, {
  ...
  parse: function (str) {
    ...
    return new Date(2000 + parseInt(yearMonth[1]), yearMonth[0] - 1);
  }
});
...
document.getElementById('payment-form').addEventListener('submit', function (event) {
  ...
  modalSucessPagamento();


});


let chamarModalPagamento = () => {
  let modalPagamento = document.querySelector('.modalPagamento');
  modalPagamento.classList.add('show');
}


const closeModalPayment = document.querySelector('.closePagamento');
...
let modalSucessPagamento = () => {
  let sucessoModal = document.getElementById('successModal');

  sucessoModal.classList.add('active');


  setTimeout(() => {
    let conteudoSucesso = document.querySelector('.modalSucess-content');
    let loarder = document.querySelector('.loader');
    loarder.classList.add('disabled');


    conteudoSucesso.innerHTML = `
    <span class="modalCloseSucess"></span>
              <h2>Sucesso!</h2>
              <p>Seu pagamento foi realizado com sucesso. <strong>Cheque seu e-mail para obter mais informações!</strong></p>
              <div id="closeBtn">Fechar</div>
